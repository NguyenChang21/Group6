...
public class ExecuteSQL {
    public boolean insertStudent(Student student, Connection conn) throws SQLException {
    ...
    public boolean insertTeacher(Teacher teacher, Connection conn) throws SQLException {
    ...
    public ResultSet searchStudent(Student student, Connection conn, int id) throws SQLException {
...
//    public ResultSet searchTeacher(Teacher teacher, Connection conn){
//
//    }
//
